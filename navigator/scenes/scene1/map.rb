...
class Map
  # マップチップ毎の画像イメージ
  CELL_IMAGES = Image.loadToArray(File.join("images", "map_chips.png"), 5, 5)
  ...
  #
  #           [start]
  def calc_route(start, goal, hide_goal = false)
    g = Graph.new(make_data(hide_goal))
